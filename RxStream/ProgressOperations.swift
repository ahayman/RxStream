...
public extension Progression {
  ...
  */
  func onProgress(_ handler: @escaping (ProgressEvent<ProgressUnit>) -> Void) -> Progression<ProgressUnit, T> {
  ...
  */
  func mapProgress<U>(_ mapper: @escaping (ProgressEvent<ProgressUnit>) -> ProgressEvent<U>) -> Progression<U, T> {
  ...
  @discardableResult public func combineProgress<U, R, P>(
    ...
    progressMapper mapper: @escaping (EitherAnd<ProgressEvent<ProgressUnit>, ProgressEvent<R>>) -> ProgressEvent<P>) -> Progression<P, (T, U)>
  {
